...
-- Tiempo de generación: 08-05-2023 a las 13:21:52
...
(1, 'Requerimientos incompletos', 'Los Requerimientos no se definieron de manera clara y completa', 5, 5, 'Muy Alto', '', '', '', '', ''),
(2, ' Falta de acompañamiento de los usuarios en el levantamiento de requerimientos', ' Usuarios que no colaboran o no se compreten con la definición de los requerimientos', 4, 4, 'Alto', '', '', '', '', ''),
(3, 'Diseño de interfaces incompleto', 'Desconocimiento de todas las interfases que pueden afectar la solución', 3, 3, 'Medio', '', '', '', '', ''),
